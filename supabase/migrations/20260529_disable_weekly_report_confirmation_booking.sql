-- Disable automatic saldo/profile-hour booking when a weekly report is controlled.
-- The frontend still writes `weekly_reports.controll`, but that update must no longer
-- change app_profiles balances.
